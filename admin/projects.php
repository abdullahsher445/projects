...
<a href="/admin/add_project.php" class="btn btn-accent mb-3">Add Project</a>
<table class="table table-striped bg-white"><tr><th>Image</th><th>Title</th><th>Category</th><th>Actions</th></tr>
<?php foreach($projects as $p): ?><tr><td><img class="thumb" src="<?= e($p['image_path'] ?: '/assets/images/project-placeholder.svg') ?>"></td><td><?= e($p['title']) ?></td><td><?= e($p['category']) ?></td><td><a class="btn btn-sm btn-dark" href="/admin/edit_project.php?id=<?= (int)$p['id'] ?>">Edit</a> <a class="btn btn-sm btn-danger" href="?delete=<?= (int)$p['id'] ?>" onclick="return confirm('Delete project?')">Delete</a></td></tr><?php endforeach; ?>
