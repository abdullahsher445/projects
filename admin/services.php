...
<a href="<?= e(url('admin/add_service.php')) ?>" class="btn btn-accent mb-3">Add Service</a>
...
<?php foreach ($services as $s): ?><tr><td><img class="thumb" src="<?= e(media_url($s['image_path'] ?: 'assets/images/service-placeholder.svg')) ?>"></td><td><?= e($s['title']) ?></td><td><?= e($s['short_description']) ?></td><td><a class="btn btn-sm btn-dark" href="<?= e(url('admin/edit_service.php')) ?>?id=<?= (int)$s['id'] ?>">Edit</a> <a class="btn btn-sm btn-danger" href="?delete=<?= (int)$s['id'] ?>" onclick="return confirm('Delete service?')">Delete</a></td></tr><?php endforeach; ?>
